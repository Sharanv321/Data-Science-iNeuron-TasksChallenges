...
# class ineuron1students is inheriting from class students
class ineuron1students(students):
    def ineuron1_students_course(self):
        log.info("ineuron1 student courses")

# class ineuron2students is inheriting from class ineuron1students
class ineuron2students(ineuron1students):
